...
public class InputCoordinates {
    ...
    public static Coordinates inputPlaceCoordinateForColor(Color color, Board board) {
        while (true) {
    ...
    public static Coordinates inputAvailableSqaure(Set<Coordinates> coordinates) {
        while (true) {
    ...
    public static void main(String[] args) {
        ...
        Coordinates coordinates = inputPlaceCoordinateForColor(Color.WHITE, board);
